...
+ (void)hsShowCenterWithText:(NSString *)text {
    [HLHJNewsToast hsShowCenterWithText:text duration:ToastDispalyDuration];
}
...
+ (void)hsShowCenterWithText:(NSString *)text duration:(CGFloat)duration {
    HLHJNewsToast *toast = [[HLHJNewsToast alloc] initWithText:text];
...
+ (void)hsShowTopWithText:(NSString *)text {
    [HLHJNewsToast hsShowTopWithText:text topOffset:ToastSpace duration:ToastDispalyDuration];
}
...
+ (void)hsShowTopWithText:(NSString *)text duration:(CGFloat)duration {
    [HLHJNewsToast hsShowTopWithText:text topOffset:ToastSpace duration:duration];
}
...
+ (void)hsShowTopWithText:(NSString *)text topOffset:(CGFloat)topOffset {
    [HLHJNewsToast hsShowTopWithText:text topOffset:topOffset duration:ToastDispalyDuration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text {
    [HLHJNewsToast hsShowBottomWithText:text bottomOffset:ToastSpace duration:ToastDispalyDuration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text duration:(CGFloat)duration {
    [HLHJNewsToast hsShowBottomWithText:text bottomOffset:ToastSpace duration:duration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text bottomOffset:(CGFloat)bottomOffset {
    [HLHJNewsToast hsShowBottomWithText:text bottomOffset:bottomOffset duration:ToastDispalyDuration];
}
