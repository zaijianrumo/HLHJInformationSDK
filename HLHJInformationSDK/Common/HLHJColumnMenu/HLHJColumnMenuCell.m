...
@implementation HLHJColumnMenuCell
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.emptyView.backgroundColor = [HLHJConfig colorWithHexString:@"#f4f4f4"];
        ...
        self.title.backgroundColor = [HLHJConfig colorWithHexString:@"#f4f4f4"];
...
- (void)updateAllFrame:(HLHJColumnMenuModel *)model {
...
- (void)setModel:(HLHJColumnMenuModel *)model {
    _model = model;
