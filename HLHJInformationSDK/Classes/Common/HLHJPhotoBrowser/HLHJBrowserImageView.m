...
@implementation HLHJBrowserImageView
{
    __weak HLHJWaitingView *_waitingView;
    BOOL _didCheckSize;
...
{
    HLHJWaitingView *waiting = [[HLHJWaitingView alloc] init];
    ...
    __weak HLHJBrowserImageView *imageViewWeak = self;
